...
{
    public class MiniDispenser : CooldownAbilityBase
    {
        ...
        public MiniDispenser(Player ply)
        {
            Ply = ply;
        }
        ...
        private IEnumerator<float> BuildDispenser()
		{
			...
			BuildingMapObject = UtilityMethods.SpawnSchematic("MiniDispenserChaos", buildingPosition,
			...
			{
				TimeElapsed = i;
				if(Ply.CustomClassManager().CustomClass?.Name != "Machinist")
				{
					break;
				}
