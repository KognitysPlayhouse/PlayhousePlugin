...
{
    public class ChaosTeleporterExit : CooldownAbilityBase
    {
        ...
        public ChaosTeleporterExit(Player ply)
        {
            Ply = ply;
        }
        ...
        private IEnumerator<float> TeleporterExit()
        {
            Vector3 buildingPosition = Ply.Position + Vector3.down*1.3f;
            Position = buildingPosition;
            
            BuildingMapObject = UtilityMethods.SpawnSchematic("TeleporterExitGreen", buildingPosition);
